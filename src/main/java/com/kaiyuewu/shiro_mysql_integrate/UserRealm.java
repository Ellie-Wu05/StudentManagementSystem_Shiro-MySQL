package com.kaiyuewu.shiro_mysql_integrate;

import com.kaiyuewu.shiro_mysql_integrate.Dao.UserDao;
import com.kaiyuewu.shiro_mysql_integrate.Mapper.RoleMapper;
...
public class UserRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        return new SimpleAuthenticationInfo(user.getRoleNames(),user.getPassword(),getName());
    }
}
